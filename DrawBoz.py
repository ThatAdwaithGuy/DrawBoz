...
class DrawBoz:
    ...
    @staticmethod
    def AddText(Text: str, LineNumber: int=6,position: int=1 ,TextColour: Color=Color.RESET, TextBackgroundColor: Color=Color.RESET) -> list: # should only be used in Array varible
        isColored: bool = True
        text: str = Text
